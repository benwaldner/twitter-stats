...
file1 = 'data/' + user + '2.csv'
file2 = 'data/pred/' + user + '2.csv'
limit = 10 # In pagges, not tweets
...
class TwitterSearch(metaclass=ABCMeta):
    ...
    def search(self, query):
        ...
        i = 0
        while i < limit and (response is not None and continue_search and response['items_html'] is not None):
    ...
    def parse_tweets(items_html):
        ...
        for li in soup.find_all("li", class_='js-stream-item'):
            ...
            if text_p is not None:
                tweet['text'] = text_p.get_text().strip()
    ...
    def save_tweets(self, tweets):
        ...
        for tweet in tweets:
            if tweet['created_at'] is not None:
                ...
                print(tweet['text']) #.encode('ascii', 'ignore') if on Windows
